...
<head>
	<meta charset="UTF-8">
	<title>Laporan Keuangan CV Apa saja</title>
...
<body>
	...
	<header>
		...
		<div class="heroe">
			<h1>Laporan Keuangan <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
			<h2>CV Apa saja</h2>
			<a href="/reports" class="mt-4 btn btn-primary">Masuk ke Aplikasi</a>
		</div>
	</header>
